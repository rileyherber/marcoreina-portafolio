...
africandata #display 2907 rows, 9 columns
```
...
# get an overview of data structure
str(africandata_year200)

# get a summary of data
summary(africandata_year200)
```
